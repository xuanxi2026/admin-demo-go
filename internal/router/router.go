...
func New(app *bootstrap.App) *gin.Engine {
	...
	protected.Use(middleware.Auth(app.Cfg.App.JWTSecret))
	{
		...
		protected.POST("/departmentManagement/getTree", middleware.RequirePermission(rbacSvc, "rbac:view"), adminModule.DepartmentGetTree)
		protected.POST("/departmentManagement/getList", middleware.RequirePermission(rbacSvc, "rbac:view"), adminModule.DepartmentGetList)
		protected.POST("/departmentManagement/doEdit", middleware.RequirePermission(rbacSvc, "rbac:view"), adminModule.DepartmentDoEdit)
		protected.POST("/departmentManagement/doDelete", middleware.RequirePermission(rbacSvc, "rbac:view"), adminModule.DepartmentDoDelete)
		protected.POST("/noticeManagement/getList", middleware.RequirePermission(rbacSvc, "rbac:view"), adminModule.NoticeGetList)
		protected.POST("/noticeManagement/doEdit", middleware.RequirePermission(rbacSvc, "rbac:view"), adminModule.NoticeDoEdit)
		protected.POST("/noticeManagement/doDelete", middleware.RequirePermission(rbacSvc, "rbac:view"), adminModule.NoticeDoDelete)
		protected.POST("/noticeCenter/getList", adminModule.NoticeCenterGetList)
		protected.POST("/noticeCenter/markRead", adminModule.NoticeCenterMarkRead)
		protected.POST("/noticeCenter/markUnread", adminModule.NoticeCenterMarkUnread)
